//We're in a job interview. Answer the following questions (try to not look at your notes unless you have to).
  // 1) What is the purpose of the 'this keyword'?
      ...
      //Answer
      //To refer to the object it belongs to
  // 2) What are the four rules that govern what the 'this keyword' is bound to and describe each?

      //Answer
      //window = every global object is attached to.
      //Method Assignment = instead of windows it is the object left of the dot.
      //Constructor Function = everything inside of the constructor function.
      //Constructor Prototype Method = Same properties from the latter.
  // 3) What does .bind do?
...
// Write a constructor function, including method definitions, which will make the following function invocations function properly.
  ...
  function Car(brand,version,year) {
    this.move = 0;
    this.brand = brand;
...
var userName = getMyUsername.call(this.myUser); //Fix this
