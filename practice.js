...
//We're in a job interview. Answer the following questions (try to not look at your notes unless you have to).
  // 1) What is the purpose of the 'this keyword'?
      ...
      //Answer
      'this keyword is a reference of an object'


  // 2) What are the four rules that govern what the 'this keyword' is bound to and describe each?

      //Answer
      'Implicit Binding = do what the rule of javascript i.'
      'Explicit Binding = overrides the normal behavior of a function.'
      'Default Binding = it is the default way of invoking a function.'
      'New Binding = makes a new object which can be called by another function'


  // 3) What does .bind do?

      //Answer
      '.bind provides the parameter of the new function by getting its passed properties'
